...
MODEL_RUN_PROFILES: dict[str, ModelRunProfile] = {
    ...
    "current_recommended_serving_alpha_sidecar_race_norm": ModelRunProfile(
        ...
        model_config="configs/model_catboost_value_stack_lgbm_roi_high_coverage_tune_roi012_liquidity_regime_hybrid_june_strict_serving_alpha_sidecar_race_norm.yaml",
        data_config="configs/data.yaml",
        feature_config="configs/features_catboost_rich_high_coverage_diag.yaml",
    ),
    "current_recommended_serving_alpha_sidecar_race_norm_low_weight": ModelRunProfile(
        description="Bounded Stage 4 follow-up candidate that keeps the same alpha sidecar path but lowers alpha weight to reduce September exposure drift.",
        model_config="configs/model_catboost_value_stack_lgbm_roi_high_coverage_tune_roi012_liquidity_regime_hybrid_june_strict_serving_alpha_sidecar_race_norm_low_weight.yaml",
        data_config="configs/data.yaml",
        feature_config="configs/features_catboost_rich_high_coverage_diag.yaml",
    ),
    "current_recommended_serving_market_aware_prob_race_norm": ModelRunProfile(
        description="Architecture candidate that routes race-normalized alpha through a market-aware probability path instead of the legacy late-fusion sidecar path.",
        model_config="configs/model_catboost_value_stack_lgbm_roi_high_coverage_tune_roi012_liquidity_regime_hybrid_june_strict_serving_market_aware_prob_race_norm.yaml",
        data_config="configs/data.yaml",
        feature_config="configs/features_catboost_rich_high_coverage_diag.yaml",
    ),
    "current_recommended_serving_support_preserving_prob_race_norm": ModelRunProfile(
        description="Broader composition candidate that keeps baseline win probability as the support carrier and injects alpha and market information as bounded residual signals.",
        model_config="configs/model_catboost_value_stack_lgbm_roi_high_coverage_tune_roi012_liquidity_regime_hybrid_june_strict_serving_support_preserving_prob_race_norm.yaml",
        data_config="configs/data.yaml",
        feature_config="configs/features_catboost_rich_high_coverage_diag.yaml",
    ),
    ...
    "current_recommended_serving_support_preserving_prob_race_closure": ModelRunProfile(
        description="Support-preserving probability candidate with bounded post-composition race-closure adjustment for calibration diagnostics.",
        model_config="configs/model_catboost_value_stack_lgbm_roi_high_coverage_tune_roi012_liquidity_regime_hybrid_june_strict_serving_support_preserving_prob_race_closure.yaml",
        data_config="configs/data.yaml",
        feature_config="configs/features_catboost_rich_high_coverage_diag.yaml",
    ),
    "current_recommended_serving_support_preserving_prob_composite_budget": ModelRunProfile(
        description="Support-preserving probability candidate with opt-in composite budget runtime policy for late-2025 validation.",
        model_config="configs/model_catboost_value_stack_lgbm_roi_high_coverage_tune_roi012_liquidity_regime_hybrid_june_strict_serving_support_preserving_prob_race_norm_composite_budget.yaml",
        data_config="configs/data.yaml",
        feature_config="configs/features_catboost_rich_high_coverage_diag.yaml",
    ),
    ...
    "current_recommended_serving_favonly_composite_budget_revision_scoped": ModelRunProfile(
        description="Favorite-only guarded isotonic calibration candidate with revision-scoped calibration materialization for live serving after #150 validation.",
        model_config="configs/model_catboost_value_stack_lgbm_roi_high_coverage_tune_roi012_liquidity_regime_hybrid_june_strict_serving_support_preserving_prob_favonly_composite_budget_revision_scoped.yaml",
        data_config="configs/data.yaml",
        feature_config="configs/features_catboost_rich_high_coverage_diag.yaml",
    ),
