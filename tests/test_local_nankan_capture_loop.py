...
class LocalNankanCaptureLoopTest(unittest.TestCase):
    def test_capture_loop_writes_completed_manifest_from_latest_summary(self) -> None:
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            self.assertEqual(manifest["read_order"][3], "latest_race_id_source_report.upcoming_only")
            self.assertEqual(manifest["read_order"][6], "latest_race_id_source_report.filtered_out_count")
