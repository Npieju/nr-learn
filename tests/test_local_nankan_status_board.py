...
class LocalNankanStatusBoardTest(unittest.TestCase):
    ...
    def test_status_board_includes_readiness_surfaces(self) -> None:
        with tempfile.TemporaryDirectory() as tmp_dir:
            ...
            self.assertEqual(payload["read_order"][3], "readiness_surfaces.capture_loop.latest_race_id_source_report.upcoming_only")
            self.assertEqual(payload["read_order"][6], "readiness_surfaces.capture_loop.latest_race_id_source_report.filtered_out_count")
