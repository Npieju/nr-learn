    ...
    *,
    ...
    payload = {
        ...
        "read_order": [
            ...
            "recommended_action",
            "monitor_state",
            "current_outcome.summary_code",
            "current_refs.capture_upcoming_only",
            "current_refs.capture_as_of",
            "current_refs.capture_pre_filter_row_count",
            "current_refs.capture_filtered_out_count",
        ],
        "monitor_state": monitor_state,
        "monitor_phase": monitor_phase,
        "current_cycle_index": current_cycle_index,
