    ...
    try:
        ...
        wrapper_manifest = {
            ...
            "read_order": [
                ...
                "current_phase",
                "recommended_action",
                "latest_race_id_source_report.upcoming_only",
                "latest_race_id_source_report.as_of",
                "latest_race_id_source_report.pre_filter_row_count",
                "latest_race_id_source_report.filtered_out_count",
            ],
