...
feature 側の次 issue 下書きは [next_issue_class_rest_surface_interactions.md](next_issue_class_rest_surface_interactions.md) を起点にし、support hardening の parent は [next_issue_class_rest_surface_support_hardening.md](next_issue_class_rest_surface_support_hardening.md)、active child candidate は [next_issue_surface_plus_class_layoff_interactions.md](next_issue_surface_plus_class_layoff_interactions.md) を使う。
