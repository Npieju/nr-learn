...
2. current evidence の範囲では、May/August を壊さず late-September だけ改善できている
3. 次に進めるなら、この candidate を tail/aggregate window と formal serving compare の中で再確認するのが自然である
